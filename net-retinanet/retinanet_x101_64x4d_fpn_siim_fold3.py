...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/stud1901/work/data/annotations/coco/train_annotations_fold3.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/stud1901/work/data/annotations/coco/val_annotations_fold3.json',
        img_prefix='/home/stud1901/work/data/images/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
total_epochs = 20
work_dir = 'runs/retinanet_x101_64x4d_fpn_without_empty/fold3'
gpu_ids = range(0, 1)
