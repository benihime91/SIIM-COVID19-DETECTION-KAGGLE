...
data = dict(
    ...
    train=dict(
        ...
        classes=classes,
        ann_file='/home/shivgup/mmdetection/mmdetection/kaggle/coco_annotations/train_annotations_fold0.json',
        pipeline=train_pipeline,
        filter_empty_gt=True),
    val=dict(
        img_prefix='/home/shivgup/yolo/train/',
        classes=classes,
        ann_file='/home/shivgup/mmdetection/mmdetection/kaggle/coco_annotations/val_annotations_fold0.json',
...
work_dir = 'runs/cascade_rcnn_x101_32x4d_fpn_20e_coco_fold0_new'
