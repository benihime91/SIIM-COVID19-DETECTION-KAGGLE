...
data = dict(
    ...
    train=dict(
        ...
        classes=classes,
        ann_file='/home/shivgup/ayush/mmdetection/kaggle/coco_annotations/train_annotations_fold2.json',
        pipeline=train_pipeline,
        filter_empty_gt=True),
    val=dict(
        img_prefix='/home/shivgup/ayush/mmdetection/train/',
        classes=classes,
        ann_file='/home/shivgup/ayush/mmdetection/kaggle/coco_annotations/val_annotations_fold2.json',
...
work_dir = 'runs/vfnet_r50_augs_without_empty_fold2'
